...
function InitialChoice({toggleInitialChoice, setVisualize}) {
  return (
    ...
    {/* <div className='flex flex-col md:flex-row sm:text-3xl lg:text-5xl fadeIn w-5/6  justify-around items-center   mx-auto fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:static md:translate-x-0 md:translate-y-0 md:mt-56 px-10'> */}
