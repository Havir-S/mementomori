...
import { getTimeBarWidths } from '../utils/getTimeBarWidths';
...
function TimeBars() {
  ...
  return (
    <div className='text-gray-400 p-4 text-center xl:text-lg'>
        ...
        <div className='mx-auto flex flex-col xl:flex-row w-full mt-3 justify-around items-center'>
